...
function add_theme_scripts() {
    ...
    //wp_enqueue_style( 'opensans_css', 'https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;600;700;800&display=swap', array(), '1.0', 'all' );
    ...
    wp_enqueue_script( 'popper_js', 'https://cdn.jsdelivr.net/npm/@popperjs/core@2.5.4/dist/umd/popper.min.js', array(), '2.5.4', true );
    wp_script_add_data( 'popper_js', 'integrity', 'sha384-q2kxQ16AaE6UbzuKqyBE9/u/KzioAlnx2maXQHiDX9d4/zp8Ok3f+M7DPm+Ib6IU' );
